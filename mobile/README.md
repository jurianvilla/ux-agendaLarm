...
Estado: base del proyecto lista (hoja de estilos, animaciones, tipografía y librerías) y **dos pantallas terminadas: M-04 · Alarmas del día y M-06 · Detalle de la alarma** (esta se abre tocando una tarjeta de la primera). Las demás se agregan encima, una por una. Sólo interfaz: no hay red, base de datos ni lógica de negocio; los datos son de muestra.
...
M-06 no se lanza directo con `adb` porque su Activity no está exportada: siempre se llega a ella desde M-04.
...
└── src/main/
    ...
    └── res/
        ├── layout/       activity_m04_alarmas_del_dia · activity_m06_detalle_alarma · include_encabezado_pantalla · include_dato_etiquetado · item_alarma · item_seccion · item_nota
        ...
        ├── drawable/     fondo_z3 · ilustracion_campana · ic_mas_opciones · punto_lugar · interruptor_pista · interruptor_pulgar · campo_fondo
...
Las pruebas unitarias viven aparte, en `app/src/test/java/com/agendalarm/app/ui/detallealarma/` (`DetalleAlarmaViewModelTest.kt`).
